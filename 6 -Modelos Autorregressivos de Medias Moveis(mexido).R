...
View(Inflacao)
plot(Inflacao, main="Índice de Preços ao Consumidor Amplo")      #Novo comnando de criar gráfico, inerente ao pacote ggplo2
...
MA3 <- arima(Inflacao,order=c(0,0,3))     #Gera a regressão autoregressiva de ordem três, nomeada aqui de MA3
MA3                                       #Exibe os resultados da Regressão

ARMA13 <- arima(Inflacao,order = c(1,0,3))#Gera a regressão autoregressiva de ordem um, zero, três, nomeada aqui de ARMA13
ARMA13                                    #Exibe os resultados da Regressão
